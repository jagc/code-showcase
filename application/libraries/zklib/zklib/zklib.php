<?php
    class ZKLib {
        ...
        public $port;
        public $zkclient;
        // public $developer_command; // don't know what it's used for, doesn't work in mes-server
        ...
        public function __construct($ip, $port) {
            $this->ip = $ip;
            $this->port = $port;
            // $this->developer_command = $developer_command; // don't know what it's used for, doesn't work in mes-server
